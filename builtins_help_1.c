...
/**
 * help_all - Displays all possible builtin xshell commands.
 */
...
void help_all(void)
{
	...
	msg = "Type 'help' to see this list.n Type 'help naeme' to find ";
	write(STDOUT_FILENO, msg, _strlen(msg));
...
/**
 * help_alias - Displays information on the xshell builtin command 'alias'.
 */
...
/**
 * help_cd - Displays information on the xshell builtin command 'cd'.
 */
...
/**
 * help_exit - Displays information on the xshell builtin command 'exit'.
 */
...
/**
 * help_help - Displays information on the xshell builtin command 'help'.
 */

void help_help(void)
{
	char *msg = "help: help\n\tSee all possible xshell builtin commands.\n";
