 ...
 * @front: A double pointr to the beginning of args.
 ...
 * @args: 2D pointer to tokenised commands and arguments.
 *
 * Return: If a ';', '&&', or '||' is placed at an invalid position - 2. Otherwise - 0.
 */
