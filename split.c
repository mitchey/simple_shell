 ...
 *
 * Return: The delimeter index marking the end of the initial token pointed to be str.
 */
 ...
 * @line: The string
 * @delim: The delimiter character to tokenise the string by.
 *
 * Return: A pointer to an array containing the tokenised words.
 */
