 ...
 * Description: Opens the stat file, a space-delimited file containing information about the current process. The PID is the first word in the file. The function reads the PID into a buffer and replaces the space at the end with a \0 byte.
 *
